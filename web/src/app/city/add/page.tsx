            ...
            <Center>
                <div style={{ height: '500px', width: '600px' }}>
                    <Map
                        ...
                        markers={city.location.latitude != 0 && city.location.longitude != 0 ? [CoordinateMapper.fromCoordinateToMarkerInfo(city.location)] : []}/>
                </div>
            </Center>
            <Center>
                <Button background={BRAND_COLOR} isDisabled={city.name.length < 3} onClick={handleCitySave}>Save</Button>
            </Center>
        </Flex>
    );
}
